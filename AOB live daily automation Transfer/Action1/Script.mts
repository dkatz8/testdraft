...
If Browser("Home - Advantage Bank").Page("Home - Advantage Bank").WebButton("Transfer done").Exist Then @@ script infofile_;_ZIP::ssf4.xml_;_
Reporter.ReportEvent micPass, " Transfer live", "  Transfer live passed  !"
else
	Reporter.ReportEvent micFail, " Transfer live ", " Transfer failed" 
	ExitTest("Order confirmation not triggered after successful payment")
End If
